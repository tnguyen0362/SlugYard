...
import com.sluggyard.tv.core.player.dvmkv.MatroskaExtractor
...
internal class DolbyVisionMatroskaTransformer(
    ...
    override fun transformHevcSample(
        ...
        val baseChanged = mp4HevcSampleInto(sample, sampleLength, nalUnitLengthFieldLength, mode)
        ...
        // The BlockAdditional RPU was converted in
        // onDolbyVisionBlockAdditionalData (or retained raw on failure).
        // Appending it here must not invoke libdovi a second time.
    ...
    private fun mp4HevcSampleInto(
        ...
        while (offset + nalUnitLengthFieldLength <= sampleLength) {
            ...
            when {
                ...
                // P7 single-track remuxes carry the enhancement layer as
                // type-63 NALs at layer 0.
