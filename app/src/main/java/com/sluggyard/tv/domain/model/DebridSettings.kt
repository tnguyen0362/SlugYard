...
import com.sluggyard.tv.core.debrid.supports

data class DebridSettings(
    val enabled: Boolean = false,
    val cloudLibraryEnabled: Boolean = true,
    val communityAddonEnabled: Boolean = true,
    val torboxApiKey: String = "",
    val premiumizeApiKey: String = "",
    val realDebridApiKey: String = "",
    val preferredResolverProviderId: String = "",
    val instantPlaybackPreparationLimit: Int = DEBRID_PREPARE_INSTANT_PLAYBACK_DEFAULT_LIMIT,
    ...
    val resolverServices: List<com.sluggyard.tv.core.debrid.DebridServiceCredential>
        get() = DebridProviders.configuredResolverServices(this)

    val activeResolverCredential: com.sluggyard.tv.core.debrid.DebridServiceCredential?
    ...
    val hasCloudLibraryProvider: Boolean
        get() = DebridProviders.configuredServices(this)
            .any { credential -> credential.provider.supports(com.sluggyard.tv.core.debrid.DebridProviderCapability.CloudLibrary) }
...
const val DEBRID_PREPARE_INSTANT_PLAYBACK_DEFAULT_LIMIT = 1
