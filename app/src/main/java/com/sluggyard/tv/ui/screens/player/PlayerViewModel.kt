...
class PlayerViewModel @Inject constructor(
    ...
    private val releaseTrackMemoryDataStore: com.sluggyard.tv.data.local.ReleaseTrackMemoryDataStore,
    ...
    private val controller = PlayerRuntimeController(
        ...
        releaseTrackMemoryDataStore = releaseTrackMemoryDataStore,
