...
private val ROW_GAP = SlugYardTheme.spacing.xxs
...
fun DisplayModeOverlay(
    ...
    Column(
        modifier = modifier
            ...
            .padding(end = SlugYardTheme.spacing.xxl, top = SlugYardTheme.spacing.xl),
        ...
        if (statusMessage != null) {
            Text(
                text = statusMessage,
                fontSize = 11.sp,
                color = SlugYardTheme.colors.Secondary,
        ...
        Row(verticalAlignment = Alignment.Top) {
            ...
            Box(
                modifier = Modifier
                    ...
                    .clip(RoundedCornerShape(SlugYardTheme.spacing.hairline))
