...
@Immutable
data class SlugYardMotionDurations(
    val instant: Int,
    val quick: Int,
    val fast: Int,
    val medium: Int,
...
@Immutable
data class SlugYardMotionEasings(
    val standard: Easing,
...
@Immutable
data class SlugYardMotionTokens(
    val durations: SlugYardMotionDurations,
    val easings: SlugYardMotionEasings,
...
@Immutable
data class SlugYardFocusTokens(
    val scale: Float,
...
object SlugYardMotion {
    val tokens = SlugYardMotionTokens(
        durations = SlugYardMotionDurations(
            instant = 0,
            quick = 125,
            fast = 180,
            medium = 350,
...
object SlugYardFocus {
    val tokens = SlugYardFocusTokens(
        scale = 1.01f,
        subtleScale = 1.005f,
        pressedScale = 0.99f,
        disabledScale = 1f,
