...
/** Quicksand is the rounded typeface used by the Debrid Streams reference app. */
...
fun buildSlugYardTypography(fontFamily: FontFamily): Typography = Typography(
...
@OptIn(ExperimentalTvMaterial3Api::class)
val SlugYardTypography = buildSlugYardTypography(InterFamily)

@OptIn(ExperimentalTvMaterial3Api::class)
fun buildSlugYardTextStyles(typography: Typography): SlugYardTextStyleTokens = SlugYardTextStyleTokens(
...
@OptIn(ExperimentalTvMaterial3Api::class)
val SlugYardTextStyles = buildSlugYardTextStyles(SlugYardTypography)
