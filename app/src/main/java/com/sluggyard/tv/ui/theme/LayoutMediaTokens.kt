...
@Immutable
data class SlugYardLayoutTokens(
...
@Immutable
data class SlugYardMediaTokens(
...
object SlugYardLayout {
    val tokens = SlugYardLayoutTokens(
...
object SlugYardMedia {
    val tokens = SlugYardMediaTokens(
