...
import com.sluggyard.tv.data.remote.api.TmdbCompany
import com.sluggyard.tv.data.remote.api.TmdbCompanyDetailsResponse
import com.sluggyard.tv.data.remote.api.TmdbCreditsResponse
import com.sluggyard.tv.data.remote.api.TmdbDetailsResponse
import com.sluggyard.tv.data.remote.api.TmdbDiscoverResponse
import com.sluggyard.tv.data.remote.api.TmdbDiscoverResult
import com.sluggyard.tv.data.remote.api.TmdbImagesResponse
import com.sluggyard.tv.data.remote.api.TmdbMovieReleaseDatesResponse
import com.sluggyard.tv.data.remote.api.TmdbNetwork
import com.sluggyard.tv.data.remote.api.TmdbNetworkDetailsResponse
import com.sluggyard.tv.data.remote.api.TmdbTvContentRatingsResponse
import com.sluggyard.tv.data.remote.api.TmdbVideosResponse
...
class TmdbMetadataServiceTest {
    ...
    @Before
    fun setUp() {
        tmdbApiKeyOverride = "test-key"
    }

    @After
    fun tearDown() {
        tmdbApiKeyOverride = null
    }
